                ...
                <div class="card">
                    ...
                    <div class="card-footer d-flex">
                        <div class="col-sm-6">
                            ...
                            <input type="submit" name="accion" value="Generar Venta" href="Controlador?menu=NuevaVenta&accion=GenerarVenta" class="btn btn-success">-->
                            <a class="btn btn-success" href="Controlador?menu=NuevaVenta&accion=GenerarVenta" onclick ="print()" target="myFrame">GenerarVenta</a>
